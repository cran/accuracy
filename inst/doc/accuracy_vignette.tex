...
(Intercept)        -3e+03       -3e+03          9e+02 -5e+03 -7e+02          *
GNP.deflator        7e-03        2e-02          8e-02 -1e-01  1e-01           
GNP                -2e-02       -4e-02          3e-02 -7e-02  5e-02          *
Unemployed         -2e-02       -2e-02          5e-03 -3e-02 -8e-03          *
Armed.Forces       -1e-02       -1e-02          2e-03 -1e-02 -6e-03          *
Population         -8e-02       -5e-02          2e-01 -5e-01  3e-01           
Year                2e+00        2e+00          5e-01  4e-01  2e+00          *
\end{Soutput}
\end{Schunk}
}
...
[1] "Sensitivity of coefficients over  500  perturbations:"
            Perturb Est. (Orig. Est.) (Orig. Stderr) 2.5% 97.5% [Unstable]
(Intercept)         49.9         49.8           13.4 48.3  51.4           
...
X-squared = 21.8241, df = 199, p-value = 1
\end{Soutput}
\end{Schunk}
}
...
data:  sample(tab, 200, replace = T) 
X-squared = 23.2212, df = 199, p-value = 1
\end{Soutput}
\end{Schunk}
} 
...
\begin{Soutput}
         [,1]    [,2]        [,3]
[1,] 1.414214 0.00000 1.767766953
[2,] 0.000000 1.41422 0.000000000
[3,] 0.000000 0.00000 0.004262202
attr(,"delta")
[1] 1.816636e-05
\end{Soutput}
\end{Schunk}
...
\begin{Soutput}
         [,1]     [,2]      [,3]
[1,] 1.414214 0.000000 1.6970563
[2,] 0.000000 1.414214 0.0000000
[3,] 0.000000 0.000000 0.3464102
\end{Soutput}
\begin{Sinput}
...
\begin{Soutput}
     [,1]     [,2]     [,3]
[1,]    2 0.000000 10.00000
[2,]    0 2.000061  0.00000
[3,]   10 0.000000 50.00006
\end{Soutput}
\end{Schunk}
\end{itemize}
}
...
Null Deviance:	    11.09 
Residual Deviance: 2.996e-10 	AIC: 12 
\end{Soutput}
\end{Schunk}
}
\vbox{
...
\begin{Soutput}
               ...
               1.55672155                0.03890147               -0.34391193 
       Per-Pupil Spending Percent Minority Teachers                Class Size 
               0.01008860                0.99276824               -3.42488161 
\end{Soutput}
\end{Schunk}
}
...
\begin{Soutput}
              [,1]          [,2]          [,3]         [,4]         [,5]
[1,]     -2.189485     -69.78984     -35.30545    -10947.97     -47.6213
[2,]    -69.789839   -2702.64572   -1123.47956   -348954.67   -1528.5343
[3,]    -35.305448   -1123.47956    -676.82459   -176529.98    -769.3303
[4,] -10947.973083 -348954.66829 -176529.97647 -54742603.37 -238118.0040
[5,]    -47.621302   -1528.53432    -769.33034   -238118.00   -1036.1738
[6,]    -44.610760   -1430.00748    -710.76161   -223064.75    -971.0367
              [,6]
[1,]     -44.61076
[2,]   -1430.00748
[3,]    -710.76161
