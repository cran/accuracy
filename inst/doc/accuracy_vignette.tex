...
\usepackage{/nfs/home/M/maltman/R-2.6.1/R-2.6.1/share/texmf/Sweave}
\begin{document}
...
(Intercept)        -3e+03       -3e+03          9e+02 -5e+03 -8e+02          *
GNP.deflator        5e-03        2e-02          8e-02 -1e-01  1e-01           
GNP                -2e-02       -4e-02          3e-02 -8e-02  5e-02          *
Unemployed         -2e-02       -2e-02          5e-03 -3e-02 -8e-03          *
Armed.Forces       -1e-02       -1e-02          2e-03 -1e-02 -6e-03          *
Population         -9e-02       -5e-02          2e-01 -5e-01  3e-01           
...
[1] "Sensitivity of coefficients over  500  perturbations:"
            Perturb Est. (Orig. Est.) (Orig. Stderr) 2.5% 97.5% [Unstable]
(Intercept)         49.8         49.8           13.4 48.4  51.4           
Prewt               -0.6         -0.6            0.2 -0.6  -0.5           
TreatCont           -4.1         -4.1            1.9 -4.3  -3.9           
...
\begin{Schunk}
\begin{Sinput}
R> zelig.out <- zelig(Employed ~ GNP.deflator + GNP + Unemployed + 
...
X-squared = 36.27, df = 199, p-value = 1
\end{Soutput}
\end{Schunk}
}
...
data:  sample(tab, 200, replace = T) 
X-squared = 20.56, df = 199, p-value = 1
\end{Soutput}
\end{Schunk}
} 
